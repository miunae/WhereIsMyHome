...
async function findUserPw(user, success, fail) {
  await api.post(`/user/findpw`, JSON.stringify(user)).then(success).catch(fail);
}
export { login, findById, tokenRegeneration, logout, registUser, modifyUser, deleteUser, getUser, findUserPw };
