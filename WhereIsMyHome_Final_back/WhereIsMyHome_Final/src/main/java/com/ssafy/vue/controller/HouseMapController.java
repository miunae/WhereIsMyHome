...
public class HouseMapController {
	...
	@ApiOperation(value = "아파트 목록 from API", notes = "지역코드와 매매계약월을 기준으로 아파트 목록을 반환한다.", response = List.class)
	...
	@GetMapping(value = "/deallist/{aptCode}", produces = "application/json;charset=utf-8")
	public ResponseEntity<List<HouseDealDto>> getHouseDeal(@PathVariable("aptCode") int aptCode) throws Exception{
		return new ResponseEntity<List<HouseDealDto>>(haHouseMapService.getDealList(aptCode), HttpStatus.OK);
	}
